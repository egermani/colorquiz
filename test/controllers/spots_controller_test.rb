...
class SpotsControllerTest < ActionController::TestCase
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post :create, spot: { color: @spot.color, image_id: @spot.image_id, radius: @spot.radius, x: @spot.x, y: @spot.y }
    end
  ...
  test "should update spot" do
    patch :update, id: @spot, spot: { color: @spot.color, image_id: @spot.image_id, radius: @spot.radius, x: @spot.x, y: @spot.y }
    assert_redirected_to spot_path(assigns(:spot))
  end
